...
PRESS_REGISTRY = {
    ...
    "kvsquared_2": KVSquaredPress(inner_press=KVSquaredPress(inner_press=KeyDiffPress())),
    "kvsquared_3": KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KeyDiffPress()))),
    "kvsquared_5": KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KeyDiffPress()))))),
    "kvsquared_10": KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KeyDiffPress())))))))))),
    "kvsquared+": KVSquaredPress(kvzip_plus_normalization=True),
    ...
    "kvsquared_10+": KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KeyDiffPress(), kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True),
    "knorm": KnormPress(),
