...
PRESS_REGISTRY = {
    ...
    "kvsquared_2": KVSquaredPress(inner_press=KVSquaredPress()),
    "kvsquared_3": KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress())),
    "kvsquared_4": KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress()))),
    "kvsquared_5": KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress())))),
    "kvsquared+": KVSquaredPress(kvzip_plus_normalization=True),
    "kvsquared_2+": KVSquaredPress(inner_press=KVSquaredPress(kvzip_plus_normalization=True), kvzip_plus_normalization=True),
    "kvsquared_3+": KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True),
    "kvsquared_4+": KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True),
    "kvsquared_5+": KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(inner_press=KVSquaredPress(kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True), kvzip_plus_normalization=True),
    "knorm": KnormPress(),
